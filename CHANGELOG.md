...
## [Unreleased]
### Changed
* doc markers to html comment style: `// [HELP_START]` to `<!-- [HELP_START] -->`
...
### Changed
* optimized regex matching performance using `regex::RegexSet` for fast pre-filtering (reduces string scans per line)
* refactor highlighting logic in `src/run.rs` to use range-based tracking for better memory efficiency (reduces auxiliary memory from $O(N)$ to $O(M)$ where $N$ is line length and $M$ is match count)
...
* update depends: memx-cdy(0.1.13), runnel(0.3.19), naive_opt(0.1.22)
...
* update depends: naive_opt(0.1.21)
...
[Unreleased]: https://github.com/aki-akaguma/aki-mline/compare/v0.2.1..HEAD
[0.2.1]: https://github.com/aki-akaguma/aki-mline/compare/v0.2.0..v0.2.1
[0.2.0]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.32..v0.2.0
...
[0.1.28]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.27..v0.1.28
[0.1.27]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.26..v0.1.27
[0.1.26]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.25..v0.1.26
[0.1.25]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.24..v0.1.25
[0.1.24]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.23..v0.1.24
[0.1.23]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.22..v0.1.23
[0.1.22]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.21..v0.1.22
[0.1.21]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.20..v0.1.21
[0.1.20]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.19..v0.1.20
[0.1.19]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.18..v0.1.19
[0.1.18]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.17..v0.1.18
[0.1.17]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.16..v0.1.17
[0.1.16]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.15..v0.1.16
[0.1.15]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.14..v0.1.15
[0.1.14]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.13..v0.1.14
[0.1.13]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.12..v0.1.13
[0.1.12]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.11..v0.1.12
[0.1.11]: https://github.com/aki-akaguma/aki-mline/compare/v0.1.10..v0.1.11
[0.1.10]: https://github.com/aki-akaguma/aki-mline/releases/tag/v0.1.10
